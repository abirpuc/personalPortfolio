...
export default function SkillsCard({item}) {
  ...
  return (
    <div className='group rounded-md text-center relative bg-[#dae8e7] hover:bg-zinc-200 dark:bg-gray-700/80 dark:hover:bg-[#172131] ease-in-out duration-200' data-aos="zoom-in-down" data-aos-duration="100000">
