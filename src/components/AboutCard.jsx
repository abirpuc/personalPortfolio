...
export default function AboutCard({about}) {
  ...
  return (
    <div className="bg-indigo-200 dark:bg-gray-700/80 text-primaryColor dark:text-darkPrimaryColor w-[200px]  h-[150px] rounded-md flex flex-col justify-center items-center">
